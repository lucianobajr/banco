...
CREATE SCHEMA IF NOT EXISTS lista9ex1;
...
VALUES	(5, '1996-04-10', 'Lombalgia crônica. Ativ. com esforço - coziinheira. limitação de mobilização. Fez tratº.
...
Cond. RX de col. lombar AP+P'),
	(5, '1996-04-09', 'RX Acentuada degeneração com osteofitos laterais Diminuição de espaços artic. L4-L5 - desvio
escoliótico.Cond. Fisioterapia'),
	(5, '1996-05-07', 'Terminou fisioterapia. Melhora Subjativa. Manter mais 1 série.'),
...
Cond. CUL+CT+Sintalgim'),
	(7, '1997-07-08', 'Melhora subjetiva- manter CUL rever 1 sem. se nec fisioterapia'),
	(7, '1997-04-03', 'Ombro doloroso a D. com queda do mesmo . Má postura para ativ. domésticas.Dor em face medial
